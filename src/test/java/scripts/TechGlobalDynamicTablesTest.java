...
public class TechGlobalDynamicTablesTest extends TechGlobalBase {
    ...
    public void validateDynamicTable(){
        ...
        Assert.assertEquals(TableHandler.getRowCount(techGlobalDynamicTablesPage.table), tableRowSize + 1);
        ...
        IntStream.range(0, products.length).forEach(i -> Assert.assertEquals(TableHandler.getRowCell(techGlobalDynamicTablesPage.table, 3, i).getText(), products[i]));
